...
int main()
{
    ...
    cout << "The range(with lowest) for float is from " << numeric_limits<float>::lowest() << " to " << numeric_limits<float>::max() << endl;

    cout << "The range(with lowest) for double is from " << numeric_limits<double>::lowest() << " to " << numeric_limits<double>::max() << endl;
